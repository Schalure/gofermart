...
func (m *MockUserManager) GetUserInfo(arg0 context.Context, arg1 string) (storage.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserManagerMockRecorder) GetUserInfo(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserInfo", reflect.TypeOf((*MockUserManager)(nil).GetUserInfo), arg0, arg1)
}
