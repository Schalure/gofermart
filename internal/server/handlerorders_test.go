...
func Test_LoadOrder(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			orderManagerGomockCall: orderManager.EXPECT().LoadOrder("Petya", "1234567897").Return(nil),
		...
		},
		{
			...
			orderManagerGomockCall: orderManager.EXPECT().LoadOrder("Petya", "123456789").Return(gofermaterrors.InvalidOrderNumber),
			tokenChekerGomockCall:  tokenCheker.EXPECT().CheckValidJWT("qqqq").Return("Petya", nil),
			want: struct{statusCode int}{
		...
		},
		{
			...
			requestOrder: "1234567897",
			orderManagerGomockCall: orderManager.EXPECT().LoadOrder("Petya", "1234567897").Return(gofermaterrors.DublicateOrderNumberByUser),
			tokenChekerGomockCall:  tokenCheker.EXPECT().CheckValidJWT("qqqq").Return("Petya", nil),
			want: struct{statusCode int}{
		...
		},
		{
			...
			requestOrder: "1234567897",
			orderManagerGomockCall: orderManager.EXPECT().LoadOrder("Petya", "1234567897").Return(gofermaterrors.DublicateOrderNumber),
			tokenChekerGomockCall:  tokenCheker.EXPECT().CheckValidJWT("qqqq").Return("Petya", nil),
			want: struct{statusCode int}{
		...
		},
		{
			...
			requestOrder: "1234567897",
			orderManagerGomockCall: orderManager.EXPECT().LoadOrder("Petya", "1234567897").Return(gofermaterrors.Internal),
			tokenChekerGomockCall:  tokenCheker.EXPECT().CheckValidJWT("qqqq").Return("Petya", nil),
			want: struct{statusCode int}{
